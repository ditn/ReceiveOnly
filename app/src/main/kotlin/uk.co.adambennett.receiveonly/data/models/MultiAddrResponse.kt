...
package uk.co.adambennett.receiveonly.data.models

import com.squareup.moshi.Json

class MultiAddressResponse(@Json(name = "recommend_include_fee") val recommendIncludeFee: Boolean,
...
class Wallet(@Json(name = "n_tx") val nTx: Int,
...
class Input(@Json(name = "prev_out") val prevOut: PrevOut,
            val sequence: Long,
            val script: String)

class Out(val value: Long,
...
class SymbolLocal(val code: String,
                  val symbol: String,
                  val name: String,
                  val conversion: Double,
...
class SymbolBtc(val code: String,
                val symbol: String,
                val name: String,
                val conversion: Double,
                @Json(name = "symbol_appears_after") val symbolAppearsAfter: Boolean,
...
class LatestBlock(@Json(name = "block_index") val blockIndex: Long,
                  val hash: String,
                  val height: Long,
                  val time: Long)

class Xpub(val m: String,
           val path: String)
